...
2. **查看固定的文件夹**：
   - 点击活动栏（左侧边栏）中的 RAC Folder Search 图标
   - 所有固定的文件夹都显示在"Pinned Folders"面板中

3. **打开固定的文件夹**：
   - 点击任何固定的文件夹以在资源管理器中打开它

4. **取消固定文件夹**：
   - 点击"Pinned Folders"面板中文件夹旁边的固定图标
   - 或右键单击并选择"Unpin Folder"

5. **清除所有固定的文件夹**：
   - 点击"Pinned Folders"面板标题栏中的清除按钮（🗑️）
